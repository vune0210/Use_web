 ...
 *
 */
public abstract class AbstractBooleanResultForBinaryIntegerRealArgumentTerm extends AbstractBooleanResultTerm {
	 ...
	 */
	public AbstractBooleanResultForBinaryIntegerRealArgumentTerm(IIntegerResultTerm left, IRealResultTerm right) {
